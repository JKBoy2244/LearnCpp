...
namespace secondScienceCombinedGrade {
  int combinedScienceGradeTwo() {
    ...
    [[maybe_unused]] static int scienceGradeTwo {};                                //This line is there to prevent the program from complaining that this variable isnt used if user decides to input 3 science grades instead of 2
    cin >> scienceGradeTwo;
